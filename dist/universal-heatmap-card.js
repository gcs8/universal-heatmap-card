 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: kt, defineProperty: Et, getOwnPropertyDescriptor: Mt, getOwnPropertyNames: Ct, getOwnPropertySymbols: Nt, getPrototypeOf: Tt } = Object, S = globalThis, Ve = S.trustedTypes, Lt = Ve ? Ve.emptyScript : "", oe = S.reactiveElementPolyfillSupport, q = (s, e) => s, pe = { toAttribute(s, e) {
  switch (e) {
    case Boolean:
      s = s ? Lt : null;
      break;
  ...
  return t;
} }, ot = (s, e) => !kt(s, e), Be = { attribute: !0, type: String, converter: pe, reflect: !1, useDefault: !1, hasChanged: ot };
...
let D = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(q("properties"))) {
      const t = this.properties, i = [...Ct(t), ...Nt(t)];
  ...
  requestUpdate(e, t, i, r = !1, n) {
    ...
    if (e !== void 0) {
      ...
      if (r === !1 && (n = this[e]), i ?? (i = o.getPropertyOptions(e)), !((i.hasChanged ?? ot)(n, t) || i.useDefault && i.reflect && n === ((a = this._$Ej) == null ? void 0 : a.get(e)) && !this.hasAttribute(o._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const V = globalThis, We = (s) => s, ee = V.trustedTypes, Ge = ee ? ee.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, lt = "$lit$", A = `lit$${Math.random().toFixed(9).slice(2)}$`, ct = "?" + A, zt = `<${ct}>`, I = document, B = () => I.createComment(""), W = (s) => s === null || typeof s != "object" && typeof s != "function", $e = Array.isArray, It = (s) => $e(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", le = `[ 	
\f\r]`, P = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Xe = /-->/g, Ke = />/g, N = RegExp(`>|${le}(?:([^\\s"'>=/]+)(${le}*=${le}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), je = /'/g, Ye = /"/g, ut = /^(?:script|style|textarea|title)$/i, Rt = (s) => (e, ...t) => ({ _$litType$: s, strings: e, values: t }), g = Rt(1), F = Symbol.for("lit-noChange"), _ = Symbol.for("lit-nothing"), Je = /* @__PURE__ */ new WeakMap(), T = I.createTreeWalker(I, 129);
function ht(s, e) {
...
const Dt = (s, e) => {
  ...
  for (let o = 0; o < t; o++) {
    const l = s[o];
    let c, u, h = -1, d = 0;
    for (; d < l.length && (a.lastIndex = d, u = a.exec(l), u !== null); ) d = a.lastIndex, a === P ? u[1] === "!--" ? a = Xe : u[1] !== void 0 ? a = Ke : u[2] !== void 0 ? (ut.test(u[2]) && (r = RegExp("</" + u[2], "g")), a = N) : u[3] !== void 0 && (a = N) : a === N ? u[0] === ">" ? (a = r ?? P, h = -1) : u[1] === void 0 ? h = -2 : (h = a.lastIndex - u[2].length, c = u[1], a = u[3] === void 0 ? N : u[3] === '"' ? Ye : je) : a === Ye || a === je ? a = N : a === Xe || a === Ke ? a = P : (a = N, r = void 0);
    const m = a === N && s[o + 1].startsWith("/>") ? " " : "";
    n += a === P ? l + zt : h >= 0 ? (i.push(c), l.slice(0, h) + lt + l.slice(h) + A + m) : l + A + (h === -2 ? o : m);
  }
  return [ht(s, n + (s[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class G {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const o = e.length - 1, l = this.parts, [c, u] = Dt(e, t);
    if (this.el = G.createElement(c, i), T.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (r = T.nextNode()) !== null && l.length < o; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const h of r.getAttributeNames()) if (h.endsWith(lt)) {
          ...
          l.push({ type: 1, index: n, name: p[2], strings: m, ctor: p[1] === "." ? Ft : p[1] === "?" ? Ot : p[1] === "@" ? Pt : ae }), r.removeAttribute(h);
        ...
        if (ut.test(r.tagName)) {
          ...
          if (d > 0) {
            ...
            for (let m = 0; m < d; m++) r.append(h[m], B()), T.nextNode(), l.push({ type: 2, index: ++n });
            r.append(h[d], B());
          }
        }
...
class Ht {
  ...
  u(e) {
    ...
    for (; l !== void 0; ) {
      if (a === l.index) {
        let c;
        l.type === 2 ? c = new X(n, n.nextSibling, this, e) : l.type === 1 ? c = new l.ctor(n, l.name, l.strings, this, e) : l.type === 6 && (c = new Ut(n, this, e)), this._$AV.push(c), l = i[++o];
      }
...
class X {
  ...
  _$AI(e, t = this) {
    e = O(this, e, t), W(e) ? e === _ || e == null || e === "" ? (this._$AH !== _ && this._$AR(), this._$AH = _) : e !== this._$AH && e !== F && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : It(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var n;
    const { values: t, _$litType$: i } = e, r = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = G.createElement(ht(i.h, i.h[0]), this.options)), i);
    if (((n = this._$AH) == null ? void 0 : n._$AD) === r) this._$AH.p(t);
    else {
      const a = new Ht(r, this), o = a.u(this.options);
...
var rt;
H._$litElement$ = !0, H.finalized = !0, (rt = L.litElementHydrateSupport) == null || rt.call(L, { LitElement: H });
...
const Vt = [
  ...
  temperature: {
    ...
    range: { days: 30 },
    bucket: { interval: "day", value: "mean" },
    scale: { preset: "temperature", unit: "°", stops: Vt }
  },
  humidity: {
    id: "humidity",
    label: "Humidity",
...
function Gt(s, e = {}) {
  ...
  return new Promise((i, r) => {
    ...
    te.push({
      ...
      reject: r,
      options: t
    }), (n = t.onQueued) == null || n.call(t, Se(t.maxConcurrent)), pt();
  });
}
function Ze(s = mt) {
  return Se(Ae(s));
...
function Ae(s) {
  return typeof s != "number" || !Number.isFinite(s) ? mt : Math.min(Wt, Math.max(1, Math.floor(s)));
}
function pt() {
  var e, t;
  const s = te[0];
...
const Xt = 5e3, Kt = 24, jt = 300;
function me(s, e, t = 0) {
  var d, m, p, f, b, E, w, M, $, C, y, Ce, Ne, Te, Le, ze, Ie, Re, De, He, Fe, Oe, Pe;
  const i = Zt(s, e);
  if (i.length === 0)
    throw new Error("Universal Heatmap Card requires entity or entities.");
  const r = (Number.isInteger(t) && t >= 0 ? i[t] : void 0) ?? i[0], n = r ? e == null ? void 0 : e.states[r.entity] : void 0, a = Bt(n), o = ((d = s.scale) == null ? void 0 : d.preset) ?? a, l = dt(o), c = {
  ...
  return {
    ...
    data: {
      ...
      max_cells: ((M = s.data) == null ? void 0 : M.max_cells) ?? Xt,
      raw_history_hours: (($ = s.data) == null ? void 0 : $.raw_history_hours) ?? Kt,
      refresh_interval: Yt((C = s.data) == null ? void 0 : C.refresh_interval),
    ...
    missing: {
      mode: ((Ne = s.missing) == null ? void 0 : Ne.mode) ?? "empty"
    },
    scale: {
      ...l.scale,
      ...s.scale,
    ...
    layout: {
      mode: ((Te = s.layout) == null ? void 0 : Te.mode) ?? "auto",
...
function Yt(s) {
  return typeof s != "number" || !Number.isFinite(s) ? jt : Math.max(0, s);
}
function Jt(s) {
...
function Zt(s, e) {
  ...
  return ((i = s.entities) != null && i.length ? s.entities : s.entity ? [{ entity: s.entity }] : []).map((r) => {
    const n = typeof r == "string" ? { entity: r } : r, a = e == null ? void 0 : e.states[n.entity], o = n.name ?? (a && (e != null && e.formatEntityName) ? e.formatEntityName(a) : a != null && a.attributes.friendly_name ? String(a.attributes.friendly_name) : n.entity), l = Qt(n.scale);
    return {
      ...n,
      ...l ? { scale: l } : {},
      name: o
...
function K(s, e = /* @__PURE__ */ new Date()) {
  const t = s.align === "day" && !s.end, i = s.end ? new Date(s.end) : t ? ei(e) : e;
  let r;
  if (s.start)
    r = new Date(s.start);
  else if (typeof s.hours == "number")
    r = t ? ii(i, s.hours) : new Date(i.getTime() - s.hours * 60 * 60 * 1e3);
  else {
    const n = typeof s.days == "number" ? s.days : 30;
    r = t ? ti(i, n) : new Date(i.getTime() - n * 24 * 60 * 60 * 1e3);
  }
...
function _t(s, e = /* @__PURE__ */ new Date()) {
...
function oi(s, e) {
  ...
  switch (e) {
    ...
    case "hour":
      return t.setTime(t.getTime() + ni), t;
    case "day":
...
async function mi(s, e, t) {
  const i = _t(e), r = K(e.range), n = li(r, e.bucket.interval);
    ...
    try {
      ...
      if (a === "statistics")
        return {
          ...
          warning: gt(l, "Statistics query failed.")
        };
    }
  return a === "auto" || a === "history" ? _i(s, e, t, n) : {
    source: "current",
    buckets: k(n, "current"),
...
async function pi(s, e, t, i) {
  ...
  return ci(i, o, e.bucket.value, e.missing.mode);
}
async function _i(s, e, t, i) {
  ...
  try {
    ...
    return {
      source: "history",
      buckets: ui(i, l, e.bucket.value, e.missing.mode)
    };
  } catch (a) {
    return {
      source: "history",
      buckets: k(i, "history"),
      warning: gt(a, "History fallback failed.")
    };
  }
}
function gt(s, e) {
...
const fi = "universal-heatmap-card:debug";
function gi(s) {
  var e;
  ...
  if ((s == null ? void 0 : s.debug) === !1 || typeof window > "u")
    return !1;
  try {
    const t = (e = window.localStorage) == null ? void 0 : e.getItem(fi);
    return t === "1" || t === "true";
  } catch {
    return !1;
  }
...
function Q(s) {
  return vt(s).map((e) => typeof e == "string" ? e : e.entity).filter((e) => typeof e == "string" && e.length > 0);
}
function vt(s) {
  var t;
...
const yt = 56, ge = 8, vi = 12, yi = 6, Ee = 4, xi = 12, wi = 560, Qe = 3, $i = 7, Ai = 22, Si = 14, ki = 28, Ei = 58, Mi = 18;
function Ci(s, e, t = Me(e, Math.max(1, s.length))) {
...
function Ti(s) {
  ...
  return e * yt + Math.max(0, e - 1) * ge;
}
function Li(s) {
  return !Number.isFinite(s) || s <= 0 ? Ee : Math.ceil((s + ge) / (yt + ge));
}
function zi(s, e = {}) {
  return Hi(
    Li(xt(s, e)),
...
function Ii(s, e = {}) {
  return Math.max(1, Math.ceil(xt(s, e) / 50));
}
function xt(s, e = {}) {
  return wt(s, e) + Ri(s);
}
function wt(s, e = {}) {
  let t = 58;
  return t += 16, s.entities.length > 1 && (t += Di(s)), (e.loading || e.warning || e.error) && (t += 33), s.axes.show_key && (t += 24), t += 25, s.legend.show && (t += 25), t;
}
function Ri(s, e = wi) {
  const t = Math.max(1, _t(s)), i = Me(s.bucket.interval, t), r = Math.ceil(t / i), n = s.axes.show && s.axes.y_labels ? Ei : 0, a = s.axes.show && s.axes.x_labels ? Mi : 0, o = Math.max(160, e - n), l = s.tiles.show_values || s.tiles.show_value_toggle, h = Math.max(
    l ? Si : $i,
    Math.min(
      l ? ki : Ai,
...
function Oi(s, e) {
  var p;
  const t = s.map((f) => f.value).filter((f) => typeof f == "number" && Number.isFinite(f)), i = t.filter((f) => f !== 0), n = e.ignore_zero === !0 || e.ignore_zero !== !1 && i.length > 0 && t.some((f) => f === 0) && !t.some((f) => f < 0) ? i : t, a = Vi(n, e.outlier_clip), o = a.min, l = a.max, { min: c, max: u } = Ui(e, o, l), h = (p = e.stops) != null && p.length ? e.stops : Fi, d = qi(h, c, u, e.invert ?? !1), m = Wi(e.sensitivity);
  return {
    min: c,
    max: u,
    unit: e.unit,
...
function Ui(s, e, t) {
  ...
  if (a > n)
    return { min: n, max: a };
  const o = et(n);
  return r ? i ? { min: n, max: n + o } : { min: a - et(a), max: a } : { min: n, max: n + o };
}
function et(s) {
  const t = Math.abs(s) * Number.EPSILON * 4;
...
function Vi(s, e) {
  if (s.length === 0)
    return { min: 0, max: 1 };
  const t = [...s].sort((a, o) => a - o), i = Bi(e);
  if (!i)
    return {
      min: t[0] ?? 0,
      max: t[t.length - 1] ?? 1
    };
  const r = tt(t, i.low), n = tt(t, i.high);
  return n <= r ? {
    min: t[0] ?? 0,
...
const ie = "universal-heatmap-card", se = "Universal Heatmap Card", Ki = "0.1.3", be = `${ie}-editor`;
...
const re = class re extends H {
  ...
  setConfig(e) {
    ...
    this._config = e, this._debug = gi(e), this._cache.clear(), this._inFlightKey = void 0, this._loadSeq += 1, this._normalized = me(e, this.hass, this._activeIndex);
  ...
  getGridOptions() {
    var o, l, c, u, h, d, m, p;
    const e = (l = (o = this._config) == null ? void 0 : o.grid_options) == null ? void 0 : l.rows, t = (u = (c = this._config) == null ? void 0 : c.grid_options) == null ? void 0 : u.columns, i = typeof e == "number" && Number.isFinite(e) ? Math.max(1, e) : this._estimatedGridRows(), r = typeof t == "number" && Number.isFinite(t) ? Math.max(1, t) : vi, n = (d = (h = this._config) == null ? void 0 : h.grid_options) == null ? void 0 : d.min_rows, a = (p = (m = this._config) == null ? void 0 : m.grid_options) == null ? void 0 : p.min_columns;
    return {
      rows: i,
      columns: r,
      min_rows: typeof n == "number" && Number.isFinite(n) ? Math.min(n, i) : Math.min(Ee, i),
      min_columns: typeof a == "number" && Number.isFinite(a) ? Math.min(a, r) : Math.min(yi, r)
    };
  }
  connectedCallback() {
  ...
  _estimatedMasonryRows() {
    const e = this._normalized;
    return e ? Ii(e, this._layoutState()) : 6;
  }
  _layoutState() {
    return {
  ...
  _renderLegend() {
    ...
    return g`
      <div class="legend">
        ...
        <div
          class="legend-bar"
          style=${`background: linear-gradient(90deg, ${Pi(this._scale)});`}
        ></div>
        <span>${t}</span>
      </div>
    `;
  ...
  async _loadActiveSeries() {
    ...
    try {
      ...
      if (a !== this._loadSeq)
        return;
      const u = this._debug ? U(x() - l) : 0, h = this._debug ? x() : 0, d = Oi(c.buckets, {
        ...e.scale,
        ...i.scale
  ...
  _drawHeatmap() {
    ...
    for (const u of ((c = this._placement) == null ? void 0 : c.cells) ?? []) {
      ...
      if (!h)
        continue;
      const d = o.cell / u.slots, m = o.gridX + u.col * (o.cell + o.gap) + u.slot * d, p = o.gridY + u.row * (o.cell + o.gap), f = $t(h.value, this._scale);
  ...
  _calculateLayout(e, t) {
    var $;
    const i = (($ = this._normalized) == null ? void 0 : $.bucket.interval) ?? "day", r = Math.max(1, this._buckets.length), n = Me(i, r), a = Ci(this._buckets, i, n);
    this._placement = a;
  ...
  _formatCellValue(e, t) {
    ...
    const r = Math.abs(this._scale.max - this._scale.min), n = ri(r, t);
  ...
  _boundedCanvasHeight() {
    ...
    if (!t)
      return;
    const i = Ti(e) - wt(t, this._layoutState());
    if (!(i <= 0))
  ...
  _handleCanvasMove(e) {
    ...
    const f = m.slots > 1 ? ` (${Ni(p.start)})` : "", b = `${this._formatDate(p.start)} - ${this._formatDate(p.end)}${f}: ${R(
      p.value,
      this._scale,
...
const ne = class ne extends H {
  ...
  _handleEntityNameInput(e, t) {
    if (!this._config)
      return;
    const i = t.target;
    this._applyConfig(bi(this._config, e, i.value));
  }
